...
alias cdcsc='cdc ApolloCSCUploader'
alias cdhu='cdc ApolloHubUser'
alias cdgsa='cdc ApolloGoSA'
alias cdmd='cdc ApolloMyDevices'
alias cdms='cdc ApolloPlatformMicroServices'
alias cdsa='cdc ApolloSupportAutomation/client'
alias cdsc='cdc ApolloSupportCases'
alias cdssa='cdc ApolloSAStandalone'
alias cdsst='cdc ApolloSAStandalone/build/standalone/staging'
